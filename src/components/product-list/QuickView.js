                ...
                <Grid container direction="column" alignItems="center">
                    ...
                    <Grid item container justify="center" classes={{root: classes.toolbar}}>
                        ...
                        <Grid item classes={{root: classes.chipContainer}}>
                            <Chip label={`$${price}`} classes={{root: classes.chipRoot}} component={Link} to={`/${product.node.category.name.toLowerCase()}/${product.node.name.split(" ")[0].toLowerCase()}${hasStyles ? `?style=${variant.style}` : ""}`} />
                        </Grid>
